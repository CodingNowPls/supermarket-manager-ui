      ...
      <el-table-column
        ...
        <template v-slot="scope">
          ...
          <el-tag v-else type="danger" style="font-size: 14px;">
            <i class="iconfont icon-r-no" style="font-size: 14px;"> </i> 停用
          </el-tag>
        </template>
      </el-table-column>
      <el-table-column
        ...
        <template v-slot="scope">
          ...
          <el-button type="danger" @click="forbidden(scope.row.id)" style="font-size: 18px;">
            <i class="iconfont icon-r-no" style="font-size: 18px;"> </i> 停用
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
import {deactivate, listByQo, save, update} from "@/api/person/deptApi";
